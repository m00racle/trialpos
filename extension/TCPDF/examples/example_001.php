...
// TODO: learn more about this to set the header with cafe logo!
...
// set margins
// TODO: this should be adjusted since the page we will use is A7 format: then remember the size is in mm unit;
